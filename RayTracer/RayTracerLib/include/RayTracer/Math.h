...
// transformations, you'd use t.linear() * vec for vectors, and t * p for
// points. Instead, I will use Vector4f, where the w coefficient determines
// whether it's a point (w = 1) or a vector (w = 0), and I'll use
// Eigen::Matrix4f to store transformations instead of Eigen::Transform. This
// way a transformation t * v will do the right thing regardless of v being a
// vector or a point.
